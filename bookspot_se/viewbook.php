...
<body>
  ...
  <nav>
    ...
    <div class="leftinnerdiv">
      <!-- <Button class="btn" onclick="openpart('bookrecord')">Book Record</Button> -->
      <div class="rightinnerdivv">  
      	...
      	<?php
            ...
            $u=new data;
            $u->setconnection();
            $u->viewbook($branchsub);
            $recordset=$u->viewbook($branchsub);

            $table="<table class='tabletwo'><tr><th style=' 
            padding: 8px;'>Book Id</th><th>Book Name</th><th>Book Detail</th><th>Book Author</th><th>Book Pub.</th><th>Subject</th><th>Book file</th></tr>";
            foreach($recordset as $row){
               ...
               "<td>$row[0]</td>";
                ...
                $table.="<td>$row[5]</td>";
                $table.="<td>$row[6]</td>"; 
                $table.="<td><a href='./uploads/$row[1]'> View </a></td>";
                $table.="</tr>";
                // $table.=$row[0];
